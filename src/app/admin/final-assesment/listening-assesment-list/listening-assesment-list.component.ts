...
@Component({
  selector: 'app-listening-assesment-list',
  templateUrl: './listening-assesment-list.component.html',
  styleUrls: ['./listening-assesment-list.component.css']
})
export class ListeningAssesmentListComponent implements OnInit {
  exerciseList = [] as any
  selectedVal: any = 20;
  ...
  add(): any {
    this.router.navigate(['admin/app/add-listening-assesment/' + 0]);
  }

  edit(id: any) {
    this.router.navigate(['admin/app/add-listening-assesment/' + id]);
  }
