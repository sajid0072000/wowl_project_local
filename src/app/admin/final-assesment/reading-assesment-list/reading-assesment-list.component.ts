...
@Component({
  selector: 'app-reading-assesment-list',
  templateUrl: './reading-assesment-list.component.html',
  styleUrls: ['./reading-assesment-list.component.css']
})
export class ReadingAssesmentListComponent implements OnInit {
  ...
  add(): any {
    this.router.navigate(['admin/app/add-reading-assesment/' + 0]);
  }

  edit(id: any) {
    this.router.navigate(['admin/app/add-reading-assesment/' + id]);
  }
